...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-background">
      <div className="aurora-silver pointer-events-none absolute -top-20 right-0 h-64 w-96 rounded-full opacity-30 blur-3xl" aria-hidden />
      <div className="grain pointer-events-none absolute inset-0 opacity-[0.03]" aria-hidden />

      {/* CTA band */}
      <div className="relative border-b border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-6 py-14 text-center md:flex-row md:text-left lg:px-10">
          <div>
            <h3 className="display-fluid font-display text-3xl text-foreground sm:text-4xl">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16 lg:px-10">
        <div className="grid gap-12 md:grid-cols-[1.6fr_1fr_1fr]">
          ...
          <div>
            <p className="eyebrow mb-5 text-[0.6rem]">Collections</p>
          ...
          <div>
            <p className="eyebrow mb-5 text-[0.6rem]">Brand</p>
            <ul className="space-y-3">
              <li>
      ...
      {/* Oversized wordmark finale */}
      <div className="relative overflow-hidden">
        <Link to="/" aria-label="CarCentralCo home" className="block">
          <p className="select-none whitespace-nowrap text-center font-display text-[19vw] font-medium leading-[0.8] tracking-tight text-white/[0.04] transition-colors duration-700 hover:text-white/[0.07]">
            CARCENTRALCO
          </p>
        </Link>
      </div>
