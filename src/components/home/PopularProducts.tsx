...
import { Flame, Star, Heart, Bell } from "lucide-react";
...
function PopularProductCard({ product }: { product: Product }) {
  ...
  return (
    <motion.div
      ...
      className="group flex h-full flex-col overflow-hidden rounded-lg border border-white/10 bg-charcoal transition-colors duration-500 hover:border-silver/40"
    >
      {/* Image */}
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-5">
          <button
            ...
            className="hairline flex w-full items-center justify-center gap-2 rounded-sm px-5 py-3 text-xs font-bold uppercase tracking-[0.22em] text-silver transition-all duration-300 hover:border-silver/50 hover:text-foreground"
          >
